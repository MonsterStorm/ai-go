...
| `agents/` | Fourteen professional role subagents: product analyst, system architect, backend architect, backend expert, frontend expert, mobile expert, data engineer, AI engineer, DevOps engineer, security engineer, test engineer, issue fixer, tech reviewer, delivery reviewer |
